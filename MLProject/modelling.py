content = '''import os, sys, argparse, json, shutil
import pandas as pd
import numpy as np
...
mlflow.log_artifact(\"tmp_artifacts/report.json\", \"reports\")
...
print(\"Selesai!\")
'''
with open('MLProject/modelling.py', 'w') as f:
    f.write(content)
print('modelling.py berhasil ditulis!')
